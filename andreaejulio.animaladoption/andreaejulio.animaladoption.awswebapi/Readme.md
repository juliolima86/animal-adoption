...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *andreaejulio.animaladoption.awswebapi*):

Restore dependencies
```
    cd "andreaejulio.animaladoption.awswebapi"
    dotnet restore
```

Execute unit tests
```
    cd "andreaejulio.animaladoption.awswebapi/test/andreaejulio.animaladoption.awswebapi.Tests"
    dotnet test
```

Deploy application
```
    cd "andreaejulio.animaladoption.awswebapi/src/andreaejulio.animaladoption.awswebapi"
